		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<tbody>
				<c:forEach items="${sl}" var="s" varStatus="st">
					<tr class="text-c">
						<td><input type="checkbox" value="${s.teacherid}" name="items"></td>
						<td>${s.teacherid}</td>
						<td>${s.name}</td>
						<td class="td-manage"><a title="编辑" href="javascript:;" onclick="member_edit('编辑','teacher-update.html?id=${s.teacherid}','4','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a><a title="删除" href="javascript:;" onclick="member_del(this,${s.teacherid})" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
